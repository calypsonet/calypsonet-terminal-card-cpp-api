...
public:
     ...
     * @since 1.0.0
     */
    virtual const std::shared_ptr<CardSelectionRequestSpi> getCardSelectionRequest() = 0;
    ...
    virtual const std::shared_ptr<SmartCardSpi> parse(
        const std::shared_ptr<CardSelectionResponseApi> cardSelectionResponseApi) = 0;
};
